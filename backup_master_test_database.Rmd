...
### Test 10 (Week4) (assignment 7:Part 1): Probabble questions
...
#### Which of the following is a legitimate question regarding statistical tests?
...
#### If we use court case as an analogy to statistical test, then presumption of innoncence in a court case is equivalent to null hypothesis in a statistical test. True or false?
...
#### In the case of facial plastic surgery example, the null hypotheis assumes that  mean perceived change in price is equal to `_____`. 
...
#### Which of the following is true about p-vale?
